...
# Gambar fallback solid abu-abu 1×1 px (JPEG) — dipakai jika semua retry gagal
...
IMAGE_DOWNLOAD_TIMEOUT   = int(os.getenv("IMAGE_DOWNLOAD_TIMEOUT", "60"))
IMAGE_MIN_BYTES          = int(os.getenv("IMAGE_MIN_BYTES",        "2048"))   # < 2 KB dianggap gagal
IMAGE_RETRY_DELAY        = float(os.getenv("IMAGE_RETRY_DELAY",    "3"))      # detik antar retry
